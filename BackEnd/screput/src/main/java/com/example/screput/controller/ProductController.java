package com.example.screput.controller;
...
public class ProductController {
    ...
    @Operation(summary="Lấy ra danh sách sản phẩm mới nhất giới hạn số lượng")
    ...
    @GetMapping("/price")
    @Operation(summary="Lấy ra danh sách 8 sản phẩm có giá từ thấp đến cao")
